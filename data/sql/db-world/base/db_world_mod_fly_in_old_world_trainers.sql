...
-- Uses a book display ID (45695) and links directly to spell 200001
...
VALUES (900002, 13, 0, 'Tome of Old World Flight', 45695, 2, 0, 5000000, 100000, 0, -1, -1, 60, 200001, 0, 0, 'Use: Allows the player to ride flying mounts in Azeroth.');
